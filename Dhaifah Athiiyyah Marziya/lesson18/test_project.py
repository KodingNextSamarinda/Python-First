# import modul pygame ke dalam program ini
import pygame

# aktifkan perpustakaan pygame
# memulai pygame dan memberikan izin
# untuk menggunakan fungsionalitas pygame.
pygame.init()

# membuat objek permukaan tampilan
...
letter3 = Font.render("I", False, orange, yellow)
letter4 = Font.render("A", False, orange, green)
letter5 = Font.render("N", False, orange, yellow)
letter6 = Font.render("D", False, orange, green)
letter7 = Font.render("A", False, orange, yellow)
